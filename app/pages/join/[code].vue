  ...
  <div class="flex w-full justify-center bg-sky-500">
    <div class="max-w-md py-4 px-8 bg-white shadow-lg rounded-lg my-20">
      ...
      <div>
        ...
        <p v-show="!accept" class="mt-6 text-gray-600" v-html="description"/>
...
:disabled="!ready"
          ...
          <button :disabled="!ready" class="m-2 rounded px-4 py-2 font-semibold" @click="copySecret">
            <svg
v-show="!ready" class="animate-spin -ml-1 mr-3 h-5 w-5" fill="none"
...
class="opacity-75"
            ...
            <svg
v-show="ready" class="h-6 w-6" fill="none" stroke="currentColor" stroke-width="2"
                 viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              <path
      ...
      <div v-show="!accept" class="checkbox my-3">
        <div id="captcha" data-theme="light"/>
      </div>
      <div class="flex justify-end mt-4">
        ...
        >
          <svg
v-show="!ready" class="animate-spin -ml-1 mr-3 h-5 w-5 text-white" fill="none"
               viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"/>
            <path
class="opacity-75"
